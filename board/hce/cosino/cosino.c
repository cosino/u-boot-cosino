 ...
 *
 * Based on at91sam9x5ek.c Copyright (C) 2012 Atmel Corporation
 *
...
static void cosino_nand_hw_init(void)
{
...
static void cosino_lcd_hw_init(void)
{
	struct at91_pmc *pmc = (struct at91_pmc *)ATMEL_BASE_PMC;
...
void lcd_show_board_info(void)
{
	...
	if (has_lcdc()) {
		lcd_printf("%s\n", U_BOOT_VERSION);
		lcd_printf("(C) 2013 HCE Engeneering\n");
		lcd_printf("www.cosino.it\n");
